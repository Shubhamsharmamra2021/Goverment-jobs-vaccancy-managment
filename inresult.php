   ...
   if(isset($_POST['submit'])){
                 $slug=preg_replace('/[^a-z0-9]+/i', '-', trim (strtolower($_POST['title'])));
                    ...
                    $resul    =  $_POST['result']; 
                     ...
                     $insertquery="insert into admitcard(  `Title`, `Headerofpost`, `Departmentofpost`, `Nameofpost`, `Dateofpost`, `Shortdisclimar`, `Applydate`, `Lastdate`, `Lastpaydate`, `Admitcarddate`, `Examdate`, `MInage`, `MAXage`, `Agepoint`, `Examfee1`, `Examfee2`, `Examfee3`, `Qualification1`, `Qualification2`, `Apply1`, `Apply2`, `Downloadlink`, `Applylink`, `Officialwebsite`, `Admitcard`) 
